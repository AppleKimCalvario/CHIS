...
<div class="container">
    <div class="content">
        <div class="left">
            <img class="logo" src="images/mho.png" alt="Logo">
            <p><b>Municipal Health Office <br> of San Vicente</b></p>
        </div>
        <div class="right">
            <form action="mhwloginbackend.php" method="post">
                <div class="form">
                    <h2>Login</h2>
                    <input type="text" id="username" name="username" placeholder="Username" required>
                    <input type="password" id="password" name="password" placeholder="Password" required>
                    <input type="submit" class="btn1" value="Login" name="">
                </div>
            </form>
        </div>
    </div>
